...
public class Tablero extends javax.swing.JFrame {
    ...
    public Tablero(ServicioMesaRuleta m) {
        tablero = m;
        initComponents();
        VentanaParametros();
        fondos();
    ...
    private void fondos() {// Coloco las imagenes en los label
        ...
        this.fondo(this.f8, "src/Casino/Juegos/Ruleta/InterfazGrafica/imagen/logo.jpg");
    }
    ...
    private void VentanaParametros() {//Establece medidas
        ...
        setTitle("Ruleta");
        setResizable(false);
        setIconImage(new ImageIcon("src/Interfaz_Test/graficosPildora/Ruleta/imagen/logo.jpg").getImage());
    }
